...
public abstract class TypeAdapter<T> {
     ...
     * Unlike Gson's similar {@link MyGson#toJson(JsonElement, Appendable) toJson}
     * method, this write is strict. Create a {@link
     * JsonWriter#setLenient(boolean) lenient} {@code JsonWriter} and call
     * {@link #write(com.example.mygson.stream.JsonWriter, Object)} for lenient
     * writing.
     *
     ...
     * MyGson#toJson(Object) toJson} method, this write is strict. Create a {@link
     * JsonWriter#setLenient(boolean) lenient} {@code JsonWriter} and call
     * {@link #write(com.example.mygson.stream.JsonWriter, Object)} for lenient
     * writing.
     *
     ...
     * similar {@link MyGson#fromJson(java.io.Reader, Class) fromJson} method, this
     ...
     * similar {@link MyGson#fromJson(String, Class) fromJson} method, this read is
