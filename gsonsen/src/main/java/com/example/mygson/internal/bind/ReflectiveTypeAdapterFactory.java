...
import com.example.mygson.FieldNamingStrategy;
...
import com.example.mygson.annotations.SerializedName;
...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    @Override public <T> TypeAdapter<T> create(MyGson gson, final TypeToken<T> type) {
    ...
    private ReflectiveTypeAdapterFactory.BoundField createBoundField(
            final MyGson context, final Field field, final String name,
    ...
    private Map<String, BoundField> getBoundFields(MyGson context, TypeToken<?> type, Class<?> raw) {
