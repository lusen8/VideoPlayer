...
import com.example.mygson.ExclusionStrategy;
import com.example.mygson.FieldAttributes;
import com.example.mygson.TypeAdapter;
import com.example.mygson.TypeAdapterFactory;
import com.example.mygson.MyGson;
import com.example.mygson.annotations.Expose;
import com.example.mygson.annotations.Since;
import com.example.mygson.annotations.Until;
...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public <T> TypeAdapter<T> create(final MyGson gson, final TypeToken<T> type) {
