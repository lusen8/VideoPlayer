...
import com.example.mygson.JsonObject;
import com.example.mygson.JsonPrimitive;
...
import com.example.mygson.internal.LazilyParsedNumber;
...
public final class TypeAdapters {
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(
        ...
        return new TypeAdapterFactory() {
            ...
            @Override public <T2> TypeAdapter<T2> create(MyGson gson, TypeToken<T2> typeToken) {
