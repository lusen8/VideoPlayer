...
/**
 * A class that allows {@link com.example.myglide.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link com.example.myglide.load.resource.transcode.ResourceTranscoder} using
   ...
   * {@link com.example.myglide.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
