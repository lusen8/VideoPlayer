...
import com.example.myglide.load.model.ModelLoader.LoadData;
import com.example.myglide.util.LogTime;
import java.util.Collections;

/**
 * Generates {@link com.example.myglide.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link com.example.myglide.load.model.ModelLoader ModelLoaders} and the model
...
class SourceGenerator implements DataFetcherGenerator,
  ...
  public void onDataReady(Object data) {
    ...
    if (data != null && diskCacheStrategy.isDataCacheable(loadData.fetcher.getDataSource())) {
      ...
      // reschedule to get back onto MyGlide's thread.
      cb.reschedule();
    } else {
