...
/**
 * A MyGlide {@link BitmapTransformation} to circle crop an image.  Behaves similar to a
...
public class CircleCrop extends BitmapTransformation {
  ...
  private static final String ID = "com.bumptech.myGlide.load.resource.bitmap.CircleCrop." + VERSION;
