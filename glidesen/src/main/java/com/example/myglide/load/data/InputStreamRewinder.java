...
import com.example.myglide.load.resource.bitmap.RecyclableBufferedInputStream;
...
public final class InputStreamRewinder implements DataRewinder<InputStream> {
  ...
  /**
   * Factory for producing {@link com.example.myglide.load.data.InputStreamRewinder}s from {@link
   * InputStream}s.
   */
