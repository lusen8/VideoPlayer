package com.example.myglide.load.engine.executor;
...
/**
 * A prioritized {@link ThreadPoolExecutor} for running jobs in MyGlide.
 */
public final class GlideExecutor extends ThreadPoolExecutor {
  ...
  /**
   * The default thread count for executors used to load/decode/transform data found in MyGlide's
   * cache.
   */
   ...
   * prefix, and the
   * {@link com.example.myglide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy#DEFAULT}
   ...
   * and {@link com.example.myglide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy}.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   *
   ...
   * com.example.myglide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy} to use to
  ...
  private static final class DefaultThreadFactory implements ThreadFactory {
    ...
    public synchronized Thread newThread(@NonNull Runnable runnable) {
      final Thread result = new Thread(runnable, "myGlide-" + name + "-thread-" + threadNum) {
        @Override
        public void run() {
