 ...
 * com.example.myglide.load.model.GlideUrl} objects and then uses the wrapped {@link
 * com.example.myglide.load.model.ModelLoader} for {@link com.example.myglide.load.model.GlideUrl}s to
 * load the data.
 */
