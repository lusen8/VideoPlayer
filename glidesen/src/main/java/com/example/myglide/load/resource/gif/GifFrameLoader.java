...
import com.example.myglide.RequestBuilder;
...
import com.example.myglide.request.target.SimpleTarget;
...
class GifFrameLoader {
  ...
  public GifFrameLoader(
      ...
      Bitmap firstFrame) {
    this(
        myGlide.getBitmapPool(),
        MyGlide.with(myGlide.getContext()),
        gifDecoder,
        null /*handler*/,
        getRequestBuilder(MyGlide.with(myGlide.getContext()), width, height),
        transformation,
        firstFrame);
  }
