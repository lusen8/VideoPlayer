...
/**
 * An exception with zero or more causes indicating why a load in MyGlide failed.
 */
public final class GlideException extends Exception {
   ...
   * failed due to an error that can be retried. Keep in mind that because MyGlide may attempt to load
