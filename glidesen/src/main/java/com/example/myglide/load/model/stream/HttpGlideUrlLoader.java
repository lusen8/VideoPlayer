...
import com.example.myglide.load.data.HttpUrlFetcher;
import com.example.myglide.load.model.GlideUrl;
import com.example.myglide.load.model.ModelCache;
...
/**
 * An {@link com.example.myglide.load.model.ModelLoader} for translating {@link
 * com.example.myglide.load.model.GlideUrl} (http/https URLS) into {@link InputStream} data.
 */
public class HttpGlideUrlLoader implements ModelLoader<GlideUrl, InputStream> {
  ...
  public static final Option<Integer> TIMEOUT = Option.memory(
      "com.bumptech.myGlide.load.model.stream.HttpGlideUrlLoader.Timeout", 2500);
