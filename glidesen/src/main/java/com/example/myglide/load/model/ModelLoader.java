...
import com.example.myglide.load.data.DataFetcher;
 ...
 * {@link com.example.myglide.load.ResourceDecoder} to decode a resource.
 */
public interface ModelLoader<Model, Data> {

  /**
   * Contains a set of {@link com.example.myglide.load.Key Keys} identifying the source of the load,
   * alternate cache keys pointing to equivalent data, and a
   * {@link com.example.myglide.load.data.DataFetcher} that can be used to fetch data not found in
   * cache.
   *
  ...
  /**
   * Returns a {@link com.example.myglide.load.model.ModelLoader.LoadData} containing a
   * {@link com.example.myglide.load.data.DataFetcher} required to decode the resource
   * represented by this model, as well as a set of {@link com.example.myglide.load.Key Keys} that
   * identify the data loaded by the {@link com.example.myglide.load.data.DataFetcher} as well as an
   ...
   *               {@link com.example.myglide.request.target.Target#SIZE_ORIGINAL} to indicate that
