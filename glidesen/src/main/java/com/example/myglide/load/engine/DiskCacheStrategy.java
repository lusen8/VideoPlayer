...
public abstract class DiskCacheStrategy {
   ...
   * {@link com.example.myglide.load.data.DataFetcher} and the
   * {@link com.example.myglide.load.EncodeStrategy} of the
   * {@link com.example.myglide.load.ResourceEncoder} (if an
   * {@link com.example.myglide.load.ResourceEncoder} is available).
   */
   ...
   * com.example.myglide.load.ResourceEncoder} will use to encode the resource.
   */
