...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback,
   ...
   * @param bitmapPool          A {@link com.example.myglide.load.engine.bitmap_recycle.BitmapPool}
   *                            that can be used to return the first frame when this drawable is
   *                            recycled.
   * @param frameTransformation An {@link com.example.myglide.load.Transformation} that can be
   ...
   * @see #setFrameTransformation(com.example.myglide.load.Transformation, Bitmap)
   */
  public GifDrawable(Context context, GifDecoder gifDecoder, BitmapPool bitmapPool,
    ...
    this(
        new GifState(
            bitmapPool,
            new GifFrameLoader(
                // TODO(b/27524013): Factor out this call to MyGlide.get()
                MyGlide.get(context),
                gifDecoder,
                targetFrameWidth,
                targetFrameHeight,
