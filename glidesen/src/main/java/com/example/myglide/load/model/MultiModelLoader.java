...
import com.example.myglide.load.data.DataFetcher.DataCallback;
 ...
 * com.example.myglide.load.engine.DataFetcherGenerator} implementations and should try to avoid this
 * duplication. </p>
 */
