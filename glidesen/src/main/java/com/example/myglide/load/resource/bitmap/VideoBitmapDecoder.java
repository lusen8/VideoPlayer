...
/**
 * An {@link com.example.myglide.load.ResourceDecoder} that can decode a thumbnail frame
...
public class VideoBitmapDecoder implements ResourceDecoder<ParcelFileDescriptor, Bitmap> {
  ...
  public static final Option<Long> TARGET_FRAME = Option.disk(
      "com.bumptech.myGlide.load.resource.bitmap.VideoBitmapDecode.TargetFrame", DEFAULT_FRAME,
  ...
  public static final Option<Integer> FRAME_OPTION = Option.disk(
      "com.bumptech.myGlide.load.resource.bitmap.VideoBitmapDecode.FrameOption",
      null /*defaultValue*/,
  ...
  public VideoBitmapDecoder(Context context) {
    this(MyGlide.get(context).getBitmapPool());
  }
