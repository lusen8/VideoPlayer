...
/**
 * A simple {@link com.example.myglide.load.Transformation} for transforming
 * {@link Bitmap}s that abstracts away dealing with
 * {@link com.example.myglide.load.engine.Resource} objects for subclasses.
 *
 * Use cases will look something like this:
 * <pre>
 * <code>
 * public class FillSpace extends BaseBitmapTransformation {
 *     private static final String ID = "com.bumptech.myGlide.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
   ...
   *
   * <p>The provided Bitmap, toTransform, should not be recycled or returned to the pool. MyGlide will
   ...
   * {@link com.example.myglide.request.target.Target#SIZE_ORIGINAL},
   * this class converts them to be the size of the Bitmap we're going to transform before calling
   * this method.
   *
   * @param pool        A {@link com.example.myglide.load.engine.bitmap_recycle.BitmapPool} that can
