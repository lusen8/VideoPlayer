...
public class Engine implements EngineJobListener,
  ...
  // Lazily instantiate to avoid exceptions if MyGlide is initialized on a background thread. See
  // #295.
