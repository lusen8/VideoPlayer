...
import com.example.myglide.load.data.ExifOrientationStream;
...
public class ThumbFetcher implements DataFetcher<InputStream> {
  ...
  // TODO(nnaze): These build methods do not need the full MyGlide or Context objects.
  ...
  private static ThumbFetcher build(Context context, Uri uri, ThumbnailQuery query) {
    ArrayPool byteArrayPool = MyGlide.get(context).getArrayPool();
    ThumbnailStreamOpener opener = new ThumbnailStreamOpener(
        MyGlide.get(context).getRegistry().getImageHeaderParsers(), query, byteArrayPool,
