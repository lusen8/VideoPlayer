...
import com.example.myglide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  /**
   * Indicates the {@link com.example.myglide.load.DecodeFormat} that will be used in conjunction
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "com.bumptech.myGlide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
   * Indicates the {@link com.example.myglide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<DownsampleStrategy> DOWNSAMPLE_STRATEGY =
      Option.memory("com.bumptech.myGlide.load.resource.bitmap.Downsampler.DownsampleStrategy",
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("com.bumptech.myGlide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
   ...
   * provided  {@link com.example.myglide.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * {@link com.example.myglide.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match
