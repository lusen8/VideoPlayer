...
import com.example.myglide.request.transition.NoTransition;
import com.example.myglide.request.transition.TransitionFactory;
import com.example.myglide.request.transition.ViewAnimationFactory;
import com.example.myglide.request.transition.ViewPropertyAnimationFactory;
import com.example.myglide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
     ...
     *
     * @param animator The {@link com.example.myglide.request.transition.ViewPropertyTransition
     *                 .Animator} to run.
     * @return This request builder.
     */
