...
import com.example.myglide.request.FutureTarget;
import com.example.myglide.request.Request;
import com.example.myglide.request.RequestCoordinator;
import com.example.myglide.request.RequestFutureTarget;
import com.example.myglide.request.RequestListener;
import com.example.myglide.request.RequestOptions;
import com.example.myglide.request.SingleRequest;
import com.example.myglide.request.ThumbnailRequestCoordinator;
import com.example.myglide.request.target.PreloadTarget;
import com.example.myglide.request.target.Target;
import com.example.myglide.signature.ApplicationVersionSignature;
...
import static com.example.myglide.request.RequestOptions.signatureOf;

/**
 * A generic class that can handle setting options and staring loads for generic resource types.
 *
 * @param <TranscodeType> The type of resource that will be delivered to the
 * {@link com.example.myglide.request.target.Target}.
 */
public class RequestBuilder<TranscodeType> implements Cloneable {
    ...
    protected RequestBuilder(MyGlide myGlide, RequestManager requestManager,
                             Class<TranscodeType> transcodeClass) {
        this.myGlide = myGlide;
        this.requestManager = requestManager;
        this.context = myGlide.getGlideContext();
    ...
    protected RequestBuilder(Class<TranscodeType> transcodeClass, RequestBuilder<?> other) {
        this(other.myGlide, other.requestManager, transcodeClass);
        model = other.model;
     ...
     * com.example.myglide.load.model.ModelLoader}, {@link com.example.myglide.load.ResourceDecoder},
     * and {@link com.example.myglide.load.Transformation}s. However,
     * {@link com.example.myglide.request.BaseRequestOptions#placeholder(int)} and
     * {@link com.example.myglide.request.BaseRequestOptions#error(int)}, and
     ...
     * {@link #into(com.example.myglide.request.target.Target)} is called. </p>
     *
     ...
     * {@link com.example.myglide.request.BaseRequestOptions#signature(com.example.myglide.load.Key)} to
     ...
     * {@link com.example.myglide.load.engine.DiskCacheStrategy#NONE} and/or
     * {@link com.example.myglide.request.BaseRequestOptions#skipMemoryCache(boolean)} may be
     * appropriate.
     * </p>
     *
     * @see #load(Object)
     ...
     * {@link com.example.myglide.load.model.UriLoader}.
     */
     ...
     * {@link com.example.myglide.request.BaseRequestOptions#signature(com.example.myglide.load.Key)}
     ...
     * the {@link com.example.myglide.load.model.ModelLoaderFactory} currently registered or
     * {@link Integer} to load the image represented by the given {@link Integer} resource id.
     * Defaults to {@link com.example.myglide.load.model.ResourceLoader} to load resource id models.
     *
     * <p> By default this method adds a version code based signature to the cache key used to cache
     * this resource in MyGlide. This signature is sufficient to guarantee that end users will see the
     ...
     * using {@link com.example.myglide.load.engine.DiskCacheStrategy#NONE} via
     * {@link BaseRequestOptions#diskCacheStrategy(com.example.myglide.load.engine.DiskCacheStrategy)}
     * during development, and re-enabling the default
     * {@link com.example.myglide.load.engine.DiskCacheStrategy#RESOURCE} for release builds. </p>
     *
     * @see #load(Integer)
     * @see com.example.myglide.signature.ApplicationVersionSignature
     */
     ...
     * the view, and frees any resources MyGlide may have previously loaded into the view so they may be
     * reused.
     *
     * @see RequestManager#clear(Target)
     *
     ...
     * @return The
     * {@link com.example.myglide.request.target.Target} used to wrap the given {@link ImageView}.
     */
     ...
     *               overridden by
     *               {@link com.example.myglide.request.BaseRequestOptions#override(int, int)} if
     *               previously called.
     ...
     * @see com.example.myglide.ListPreloader
     */
