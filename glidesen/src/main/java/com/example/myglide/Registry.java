...
import com.example.myglide.load.data.DataRewinder;
import com.example.myglide.load.data.DataRewinderRegistry;
import com.example.myglide.load.engine.DecodePath;
import com.example.myglide.load.engine.LoadPath;
...
import com.example.myglide.load.model.ModelLoaderRegistry;
import com.example.myglide.load.resource.transcode.ResourceTranscoder;
import com.example.myglide.load.resource.transcode.TranscoderRegistry;
import com.example.myglide.provider.EncoderRegistry;
import com.example.myglide.provider.ImageHeaderParserRegistry;
import com.example.myglide.provider.LoadPathCache;
import com.example.myglide.provider.ModelToResourceClassCache;
import com.example.myglide.provider.ResourceDecoderRegistry;
import com.example.myglide.provider.ResourceEncoderRegistry;
...
public class Registry {
    ...
    /**
     * Use the given factory to build a {@link com.example.myglide.load.model.ModelLoader} for models
    ...
    /**
     * Thrown when no {@link com.example.myglide.load.model.ModelLoader} is registered for a given
     * model class.
     */
