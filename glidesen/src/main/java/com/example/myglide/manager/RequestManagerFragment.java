 ...
 * com.example.myglide.RequestManager} that can be used to start, stop and manage MyGlide requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see com.example.myglide.manager.SupportRequestManagerFragment
 * @see com.example.myglide.manager.RequestManagerRetriever
 * @see com.example.myglide.RequestManager
 */
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link com.example.myglide.RequestManager}.
   *
  ...
  /**
   * Returns the current {@link com.example.myglide.RequestManager} or null if none exists.
   */
  @Nullable
  ...
  private void registerFragmentWithRoot(Activity activity) {
    ...
    rootRequestManagerFragment = MyGlide.get(activity).getRequestManagerRetriever()
