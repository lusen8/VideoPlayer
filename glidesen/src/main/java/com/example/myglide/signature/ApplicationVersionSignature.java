package com.example.myglide.signature;
...
/**
 * A utility class for obtaining a {@link com.example.myglide.load.Key} signature containing the
...
public final class ApplicationVersionSignature {
  ...
  /**
   * Returns the signature {@link com.example.myglide.load.Key} for version code of the Application
