 ...
 * {@link com.example.myglide.request.BaseRequestOptions}.
 *
 * <p>All annotated methods will be added to a single
 * {@link com.example.myglide.request.BaseRequestOptions} implementation generated per application.
...
public @interface GlideOption {
     ...
     * {@link com.example.myglide.request.BaseRequestOptions#autoClone()}.
     *
     ...
     * with {@link com.example.myglide.RequestBuilder#apply}. The static factory method by default
     * simply creates a new {@link com.example.myglide.request.BaseRequestOptions} object, calls the
