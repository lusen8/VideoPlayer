...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
   ...
   *
   * <p> For MyGlide to function correctly, MyGlide must be the only thing that calls {@link
   * View#setTag(Object)}. If the tag is cleared or put to another object type, MyGlide will not be
   * able to retrieve and cancel previous loads which will not only prevent MyGlide from reusing
   ...
   * com.example.myglide.request.Request}. </p>
   */
  @Override
  @Nullable
    ...
    if (tag != null) {
      if (tag instanceof Request) {
        ...
        throw new IllegalArgumentException(
            "You must not call setTag() on a view MyGlide is targeting");
      }
    }
    return request;
  }
   ...
   *
   * <p>
   *   If no tag id is set, MyGlide will use {@link View#setTag(Object)}.
   * </p>
   *
   * <p>
   ...
   *   on older versions, be sure to call {@link com.example.myglide.RequestManager#clear(View)} on
