...
import com.example.myglide.Priority;
import com.example.myglide.annotation.GlideOption;
...
import com.example.myglide.load.engine.DiskCacheStrategy;
import com.example.myglide.load.resource.bitmap.BitmapDrawableTransformation;
import com.example.myglide.load.resource.bitmap.BitmapEncoder;
import com.example.myglide.load.resource.bitmap.CenterCrop;
import com.example.myglide.load.resource.bitmap.CenterInside;
import com.example.myglide.load.resource.bitmap.CircleCrop;
import com.example.myglide.load.resource.bitmap.DownsampleStrategy;
import com.example.myglide.load.resource.bitmap.Downsampler;
import com.example.myglide.load.resource.bitmap.FitCenter;
...
import com.example.myglide.load.resource.gif.GifDrawableTransformation;
import com.example.myglide.load.resource.gif.StreamGifDecoder;
import com.example.myglide.signature.EmptySignature;
...
public abstract class BaseRequestOptions<CHILD extends BaseRequestOptions<CHILD>>
  ...
  /**
   * Applies a multiplier to the {@link com.example.myglide.request.target.Target}'s size before
   ...
   *                       {@link com.example.myglide.request.target.Target}'s dimensions when
  ...
  /**
   * Sets the {@link com.example.myglide.load.engine.DiskCacheStrategy} to use for this load.
   *
   * <p> Defaults to {@link com.example.myglide.load.engine.DiskCacheStrategy#AUTOMATIC}. </p>
   *
   * <p> For most applications {@link com.example.myglide.load.engine.DiskCacheStrategy#RESOURCE} is
   ...
   * using {@link com.example.myglide.load.engine.DiskCacheStrategy#DATA} or
   * {@link com.example.myglide.load.engine.DiskCacheStrategy#ALL}. </p>
   *
   ...
   * {@link com.example.myglide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.example.myglide.request.target.Target}'s width and height with the
   ...
   *
   * @param signature A unique non-null {@link com.example.myglide.load.Key} representing the current
   *                  state of the model that will be mixed in to the cache key.
   * @return This request builder.
   * @see com.example.myglide.signature.ObjectKey
   */
   ...
   * {@link com.example.myglide.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  ...
  /**
   * Sets the value for key
   * {@link com.example.myglide.load.resource.bitmap.BitmapEncoder#COMPRESSION_QUALITY}.
   */
  ...
  /**
   * Applies {@link com.example.myglide.load.resource.bitmap.CenterCrop} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context Any {@link Context}.
   * @see #optionalTransform(Class, com.example.myglide.load.Transformation)
   ...
   *
   * @param context any {@link Context}.
   * @see #transform(Class, com.example.myglide.load.Transformation)
  ...
  /**
   * Applies {@link com.example.myglide.load.resource.bitmap.FitCenter} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies {@link com.example.myglide.load.resource.bitmap.CenterInside} to all default types, and
   * ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  /**
   * Applies the given {@link com.example.myglide.load.Transformation} for
   ...
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param transformation Any {@link com.example.myglide.load.Transformation} for
   *                       {@link Bitmap}s.
   * @see #optionalTransform(com.example.myglide.load.Transformation)
   * @see #optionalTransform(Class, com.example.myglide.load.Transformation)
   */
   ...
   * {@link Bitmap Bitmaps} to the default types ({@link Bitmap},
   * {@link BitmapDrawable}, and
   * {@link com.example.myglide.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param context        Any {@link Context}.
   * @param transformation Any {@link com.example.myglide.load.Transformation} for
   *                       {@link Bitmap}s.
   * @see #transform(Context, com.example.myglide.Transformation)
   * @see #transform(Class, com.example.myglide.Transformation)
   *
   ...
   * @param transformation Any {@link com.example.myglide.load.Transformation} for
   *                       {@link Bitmap}s.
   * @see #transform(com.example.myglide.load.Transformation)
   * @see #transform(Class, com.example.myglide.load.Transformation)
   */
  @GlideOption(staticMethodName = "optionalBitmapTransform")
  ...
  /**
   * Applies the given {@link com.example.myglide.load.Transformation} for any decoded resource of
   ...
   * {@link com.example.myglide.load.Transformation} for a resource type that already has a
   * {@link com.example.myglide.load.Transformation} will override the previous call. </p>
   *
   ...
   * @param transformation The {@link com.example.myglide.load.Transformation} to apply.
   */
  ...
  /**
   * Removes all applied {@link com.example.myglide.load.Transformation Transformations} for all
   ...
   * {@link com.example.myglide.TransitionOptions#dontTransition()}</p>
   */
