...
/**
 * The standard concrete implementation of {@link com.example.myglide.request.BaseRequestOptions}.
 *
 * <p> Uses with custom types, transformations, or options can subclass and customize. {@link
 * com.example.myglide.request.BaseRequestOptions}. </p>
 */
...
public final class RequestOptions extends BaseRequestOptions<RequestOptions> {
  ...
  /**
   * Returns a {@link com.example.myglide.request.RequestOptions} with {@link
  ...
  /**
   * Returns a new {@link com.example.myglide.request.RequestOptions} with {@link #dontAnimate()}
   * called.
   */
