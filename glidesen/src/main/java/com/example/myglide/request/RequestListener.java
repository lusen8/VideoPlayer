...
public interface RequestListener<R> {
   ...
   * MyGlide.load()} to avoid object churn.
   *
   ...
   *     MyGlide.load(model).into(target);
   * }
   * }
   * </pre>
   * </p>
   ...
   *         {@code false} to allow MyGlide's request to update the target.
   */
   ...
   * Target#onResourceReady(Object, com.example.myglide.request.transition.Transition)}.
   *
