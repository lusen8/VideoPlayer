package com.example.myglide.util;

import android.view.View;
import com.example.myglide.ListPreloader;
...
/**
 * A {@link com.example.myglide.ListPreloader.PreloadSizeProvider} that will extract the preload size
