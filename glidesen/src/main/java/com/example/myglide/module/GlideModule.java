...
/**
 * An interface allowing lazy configuration of MyGlide including setting options using
 * {@link com.example.myglide.GlideBuilder} and registering
 * {@link com.example.myglide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, com.example.myglide.load.ResourceDecoder)} for each
 * {@link com.example.myglide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 *
 *                          {@literal @}Override
 *                          public void registerComponents(Context context, MyGlide myGlide) {
 *                              myGlide.register(Model.class, Data.class, new MyModelLoader());
 *                          }
 *                      }
 *                  </code>
 *             </pre>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * com.bumptech.myGlide.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="com.bumptech.myGlide.samples.flickr.FlickrGlideModule"
 ...
 * can be instantiated via reflection when MyGlide is lazily initialized. </p>
 *
